...
( function( $ ) {
	...
	wp.customize( 'first_webcomic_image', function( value ) { value.bind( function( to ) {
		if ( to ) {
			$( '#webcomic .first-webcomic-link' ).html( '<img src="' + to + '" alt="' + $( '#webcomic .first-webcomic-link' ).html() + '">' );
		} else {
	...
	wp.customize( 'last_webcomic_image', function( value ) { value.bind( function( to ) {
		if ( to ) {
			$( '#webcomic .last-webcomic-link' ).html( '<img src="' + to + '" alt="' + $( '#webcomic .last-webcomic-link' ).html() + '">' );
		} else {
	...
	wp.customize( 'previous_webcomic_image', function( value ) { value.bind( function( to ) {
		if ( to ) {
			$( '#webcomic .previous-webcomic-link' ).html( '<img src="' + to + '" alt="' + $( '#webcomic .previous-webcomic-link' ).html() + '">' );
		} else {
	...
	wp.customize( 'next_webcomic_image', function( value ) { value.bind( function( to ) {
		if ( to ) {
			$( '#webcomic .next-webcomic-link' ).html( '<img src="' + to + '" alt="' + $( '#webcomic .next-webcomic-link' ).html() + '">' );
		} else {
	...
	wp.customize( 'random_webcomic_image', function( value ) { value.bind( function( to ) {
		if ( to ) {
			$( '#webcomic .random-webcomic-link' ).html( '<img src="' + to + '" alt="' + $( '#webcomic .random-webcomic-link' ).html() + '">' );
		} else {
	...
	function archimedes_content_width() {
		var width    = 100;
